                                    ...
                                    <ul class="category-menu">
                                        ...
                                        <li class="cat-item has-children">
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                ?>
                                                <li> <a
                                                        href="product-details.php?idProd=<?php echo $rowSub['id_product'] ?>"><?php echo $rowSub['prod_name'] ?></a>
                                                </li>
                                                <?php  } ?>
                                            </ul>
                                        </li>
                                ...
                                <div class="single-slide">
                                    <div class="product-card">
                                        <div class="product-header">
                                            <a href="categorey.php?idProd=<?php echo $rowMax['id'] ?>" class="author">
                                                <?php echo $rowMax['category_name']   ?>
                                            </a>
                                            <h3><a style="max-height: 20px;"
                                                    href="product-details.php?idProd=<?php echo $rowMax['id_product'] ?>"><?php echo $rowMax['prod_name']   ?></a>
                                            </h3>
                                        </div>
                                        <div class="product-card--body">
                                            ...
                                            <div class="price-block">
                                                <span class="price"><?php 
                                                    ...
                                                    echo $rowMax['price_prod']-($rowMax['price_prod'] *$rowMax['id_dis'] /100 )
                                ...
                                <div class="single-slide">
                                    <div class="product-card">
                                        <div class="product-header">
                                            ...
                                            <h3><a style="max-height:20px"
                                                    href="product-details.php?idProd=<?php echo $rowLast['id_product']  ?>">
                                ...
                                <div class="single-slide">
                                    <div class="product-card">
                                        <div class="product-header">
                                            ...
                                            <h3><a style="max-height:20px"
                                                    href="product-details.php?idProd=<?php echo $rowMax['id_product'] ?>">
                        ...
                        <div class="product-card">
                            <div class="product-header">
                                ...
                                <h3><a style="max-height: 60px;"
                                        href="
                                        product-details.php?idProd=<?php echo $rowdiscount['id_product'] ?>"><?php echo $rowdiscount['prod_desc'] ?>
                                    </a>
                                </h3>
                            </div>
                            <div class="product-card--body">
                                ...
                                <div class="price-block">
                                    ...
                                    echo $rowdiscount['price_prod']-($rowdiscount['price_prod']*$rowQ['id_dis']/100) ;
                                }
                                    ?> JOD</span>
                                ...
                                <div class="count-down-block">
                                    <div class="product-countdown"
                                        data-countdown="<?php $date=$rowdiscount['start_disc'] ; echo date("Y-m-d H:00:00",strtotime($date)); ?>">
                                    </div>
                            ...
                            <div class="sb-slick-slider product-slider product-list-slider multiple-row slider-border-multiple-row"
                                ...
                                <div class="single-slide">
                                    <div class="product-card card-style-list">
                                        ...
                                        <div class="product-card--body">
                                            <div class="product-header">
                                                <a href="product-details.php?idProd=<?php echo $rowAuth['id_product'] ?>"
                                                    class="author">
                                                    <?php echo $rowAuth['author_name'] ?>

                                                </a>
                                                <h3><a
                                                        href="product-details.php?idProd=<?php echo $rowAuth['id_product'] ?>">
                                            ...
                                            <div class="price-block">
                                                ...
                                                <span class="price"><?php echo $rowAuth['price_prod']-($rowAuth['price_prod']*$rowQ['id_dis']/100)  
                ...
                <div class="product-list-slider slider-two-column product-slider multiple-row sb-slick-slider slider-border-multiple-row"
                    ...
                    <div class="single-slide">
                        <div class="product-card card-style-list">
                            ...
                            <div class="product-card--body">
                                <div class="product-header">
                                    <a href="categorey.php?idProd=<?php echo $catRow['id']  ?>" class="author">
                                        section
                                    </a>
                                    <h3><a
                                            href="categorey.php?idProd=<?php echo $catRow['id']  ?>"><?php echo $catRow['category_name']  ?></a>
                                    </h3>
                                </div>
                            ...
                            <div class="promo-text">
                                <div class="promo-text-inner">
                                    ...
                                    <h2><?php echo $rowL['prod_name'] ?> <br>
                                        ...
                                        <a href="cart.php?idProd=<?php echo $rowL['id_product'] ?> "
            ...
            while($rowWdiscount=mysqli_fetch_assoc($resWdiscount)){
              ?>
                    <div class="single-slide">
                        <div class="product-card">
                            <div class="product-header">
                                <a href="product-details.php?idProd=<?php echo $rowWdiscount['id_product'] ?>"
                                    class="author">
                                    <?php echo $rowWdiscount['prod_name']  ?>
                                </a>
                                <h3><a style="max-height: 60px;"
                                        href="product-details.php?idProd=<?php echo $rowWdiscount['id_product'] ?>"><?php echo $rowWdiscount['prod_desc']  ?>
                                    </a></h3>
                            </div>
                            <div class="product-card--body">
                                <div class="card-image">
                                ...
                                <div class="price-block">
                                    <span class="price"><?php
                                    $idPr= $rowWdiscount['id_product'] ;
                                    $q="select * from cat_discount_pro where id_pro = $idPr";
                                    $rs=mysqli_query($conn,$q);
                                    $rowQ=mysqli_fetch_assoc($rs);
                                    if(isset( $rowQ['id_dis'])){
                               
                                   
                                   echo $rowWdiscount['price_prod']-($rowWdiscount['price_prod']*$rowQ['id_dis']/100) ;
                               }
                        ...
                        <div class="blog-card">
                            ...
                            <div class="content">
                                <div class="content-header">
                                    ...
                                    <h3 class="title"><a
                                            href="categorey.php?idProd=<?php echo $catRowDisc['id'] ?>"><?php echo $catRowDisc['category_name'] ?></a>
                                    </h3>
                                </div>
                                ...
                                <a href="categorey.php?idProd=<?php echo $catRowDisc['id'] ?>" class="card-link">Read
                                    More
                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                ...
                                <?php
                                    ...
                                    //   $querey="select * from gallery
                                    //            inner join product
                                    //            on gallery.id_pro = product.id_product
                                    //            where id_product=";
              ...
              "focusOnSelect": true
                            ...
                            <div class="col-lg-7 mt--30 mt-lg--30">
                                <div class="product-details-info pl-lg--30 ">
                                    ...
                                    <p class="tag-block" id="cat"></p>
                                    <h3 class="product-title" id="name"></h3>
                                    <ul class="list-unstyled">

                                        <li>Price :<span class="list-value"></span></li>
                                        <li>Discount: <a href="#" class="list-value font-weight-bold">
                                                Canon</a></li>
                                        <li>Product Code: <span class="list-value"> </span></li>
                                    ...
                                    <div class="price-block">
                                        ...
                                        <span class="price-discount" id="discount"> </span>
                                    </div>
