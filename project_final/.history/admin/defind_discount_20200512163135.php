            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu active">
                        ...
                        <ul class="collapse submenu recent-submenu mini-recent-submenu list-unstyled show" id="forms"
                                        ...
                                        <div class="col-lg-6 col-12 mx-auto">
                                            <form method="post">
                                                <div class="form-group">
                                                    ...
                                                    <input id="e-text" type="email" name="email"
                                        ...
                                        <div class="col-lg-6 col-12 mx-auto">
                                            <form method="post">
                                                <div class="form-group">
                                                    ...
                                                    <input id="url-text" type="url" name="url"
                                                        placeholder="https://dummyurl.com" class="form-control"
                                                        required>
                                        ...
                                        <div class="col-lg-6 col-12 mx-auto">
                                            <form method="post">
                                                <div class="form-group">
                                                    ...
                                                    <input id="tel-text" type="tel" name="tel"
                                ...
                                <div class="widget-content widget-content-area">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-7 mx-auto">
                                            <div class="form-group">
                                                <p>Use <code>small</code> tag and <code>.text-muted</code> for helper
                                                    text. </p>
                                                <label for="h-text1" class="sr-only">Email address</label>
                                                <input type="text" class="form-control" id="h-text1"
                                                    aria-describedby="h-text1" placeholder="">
                                                <small id="sh-text1" class="form-text text-muted">I am the helper
                                                    text.</small>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    <div class="row">
                                        <div class="col-xl-7 mx-auto">
                                            <div class="form-group">
                                                <p>Wrap the <code>small</code> tag inside the <code>span</code> tag with
                                                    <code>.badge</code></p>
                                                <label for="h-text4" class="sr-only">Email address</label>
                                                <input type="text" class="form-control" id="h-text4"
                                                    aria-describedby="h-text4" placeholder="">
                                                <div class=" mt-1">
                                                    <span class="badge badge-primary">
                                                        <small id="sh-text4" class="form-text mt-0">I am the helper
                                                            text.</small>
                                                    </span>
                                                </div>
                                            </div>
                            ...
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    <div class="row">
                                        <div class="col-xl-7 mx-auto">
                                            <div class="form-group">
                                                <p>Use <code>.w-100</code> class to the <code>span</code> tag to make
                                                    block.</p>
                                                <label for="h-text7" class="sr-only">Email address</label>
                                                <input type="text" class="form-control" id="h-text7"
                                                    aria-describedby="h-text7" placeholder="">
                                                <div class="mt-1">
                                                    <span class="badge badge-primary w-100">
                                                        <small id="sh-text7" class="form-text mt-0 text-left">I am the
                                                            helper text.</small>
                                                    </span>
                                                </div>
                                            </div>
                                ...
                                <div class="widget-content widget-content-area">
                                    <form class="form-inline mb-4">
                                        <div class="form-group  d-block text-left">
                                            ...
                                            <input type="password" id="inputPassword6" class=" form-control mt-2"
                                ...
                                <div class="widget-content widget-content-area">
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="customRadioInline2" name="customRadioInline1"
                                            class="custom-control-input">
                                        <label class="custom-control-label" for="customRadioInline2">Toggle this custom
                                            radio</label>
                                    </div>
