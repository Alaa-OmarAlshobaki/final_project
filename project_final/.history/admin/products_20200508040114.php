                            ...
                            <div class="widget-content widget-content-area">
                                <div class="table-responsive mb-4">
                                    <table id="style-3" class="table style-3  table-hover">
                                        ...
                                        <tbody>
                                            <?php 
                                                 $query="SELECT * , product.id as idPro FROM product
                                                       WHERE product.id_cat = category.id";
                                                   ...
                                                   while($row =mysqli_fetch_assoc($result)){
                                                    ...
                                                    //    SELECT *,trainingadvisor.name as train_name,trainingadvisor.phone as train_phone FROM attendance,trainingadvisor,student WHERE attendance.id_student= student.id_student
                                                    //     AND attendance.id_trainingadvisor= trainingadvisor.phone AND attendance.id_academicadvisor = 123456789      
                                                ...
                                                <td class="text-center">
                                                    <div id="carouselExampleSlidesOnly" class="carousel slide"
                                                        ...
                                                        <div class="carousel-inner">
                                                            <?php
                                                             $queryGall="SELECT * FROM category WHERE 	pro_id = $id";
