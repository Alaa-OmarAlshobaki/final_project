                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php 
                                            $total = 0;
                                            $queryQuantity = " SELECT quantity FROM order_items
                                                       WHERE order_id = $id";
                                            $resultQuantity = mysqli_query($conn,$queryQuantity);
                                            while($rowQ   = mysqli_fetch_assoc($resultQuantity)){
                                                $total += isset($rowQ['quantity']);
                                        ...
                                        if(!isset($row['quantity'])){
                                            ...
                                            <td>
                                                <?php 
                                            $total = 0;
                                            $query = " SELECT list_price FROM order_items
                                                       WHERE order_id = $id";
                                            $result = mysqli_query($conn,$query);
                                            while($row    = mysqli_fetch_assoc($result)){
                                                $total += isset($row['list_price']);
