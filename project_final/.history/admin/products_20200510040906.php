                            ...
                            <div class="widget-content widget-content-area">
                                <div class="table-responsive mb-4">
                                    ...
                                    //    }
                                       ...
                                       if(isset($_POST['modal']) AND $_POST['type']=='editImages'){
                                      
                                           $pro_id=@$_POST['ProductSelect'];
                                           echo "<div class='alert alert-danger' role='alert'>
                                        This is a danger alert—check it out!$pro_id
                                      </div>" ;
                                        echo "ggggggggggggggggggggggggggggggggggggggg";
                                         die();
                                        
                                        //    $idcat=@$_POST['idcat'];
                                        $id_categore=$_POST['cat_id'];

                                           
                                           $queryFol="SELECT *  FROM product
                                           INNER JOIN category
                                            ON product.id_cat = category.id
                                            WHERE id_product= $pro_id";
                                       $resultFol=mysqli_query($conn,$queryFol);
                                       
                                       $rowFol =mysqli_fetch_assoc($resultFol);
                                       $cat_name =$rowFol['category_name'];
                                       $pro_name =$rowFol['prod_name'];
                                           ...
                                           if (!file_exists("uploads/$cat_name/$pro_name/")) {
                                            mkdir("uploads/$cat_name/$pro_name/", 0777, true);
                                        
                                        }
                                         
                                           if(!empty($_FILES["cat_img"]["type"])){
                                               $upload_dir_img="uploads/$cat_name/$pro_name/";
                                               ...
                                               if(($_FILES["cat_img"]["type"]=="image/png")||($_FILES["cat_img"]["type"]=="image/jpeg") ||($_FILES["cat_img"]["type"]=="image/jpg") && in_array($file_extension,$valid_extensions))
                                                {
                                                   ...
                                                   $hostImg="uploads/$cat_name/$pro_name/".$img_title;
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="form-group mb-4">
                            <label class="control-label" id="prosel">book Name:</label>
                            <div class="input-group col-12">
                                <select class="form-control form-control-sm" id="selectPro" name="ProductSelect">
                                    <option> Select</option>
                                    <?php
                            $querySelectPro="SELECT * FROM product
                                        
                                       ";
                            $resSelectPro=mysqli_query($conn,$querySelectPro);
                            while($rowSelectPro=mysqli_fetch_assoc($resSelectPro))
                            {

                            ?>
                                    <option value="<?php $rowSelectPro['id_product'] ?>">
                                        <?php echo $rowSelectPro['prod_name']  ?>
                                    </option>
                                    <?php } ?>
                                </select>
                            ...
                            ?>
                                        <option value="<?php $rowSelect['id'] ?>">
                                            <?php echo $rowSelect['category_name']  ?>
                                        </option>
                                        <?php } ?>
                                    </select>

                                    <input type="hidden" name="cat_name" id="cat_name" class="form-control">
                                </div>
                            </div>
                            <div class="form-group mb-4">
                            ...
                            <input id="idcat" type="hidden" name="idcat" class="form-control" required>
                            ...
                            <input id="img_id" type="hidden" name="img_id" class="form-control" required>
