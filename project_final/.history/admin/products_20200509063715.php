                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <div id="carouselExampleIndicators" style="width:30%"
                                                ...
                                                <td class="text-center">
                                                    <i onclick="editModal('<?php echo $row['category_name'] ?>','<?php echo $row['category_name'] ?>','<?php echo$row['prod_name'] ?>','<?php echo$row['prod_desc']  ?>','<?php echo$row['author_name'] ?>','<?php echo $row['product_qty'] ?>','<?php echo $id ?>')"
                                                        class="fas fa-edit "></i>
                                                </td>
                                            </tr>
                                            <?php }?>
