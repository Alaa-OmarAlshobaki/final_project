            ...
            <div class="col-6">
                <div class="form-group col-md-8 mb-4">
                    <label for="exampleFormControlTextarea1">
                        Description</label>
                    <textarea class="form-control" id="validationCustom04" placeholder="book description" value=""
                        name="prod_desc" required name="prod_desc" id="exampleFormControlTextarea1" rows="4"></textarea>
            ...
            <?php
               ...
               foreach ($_FILES['image']['name'] as $key => $img) {
                   ...
                   if (move_uploaded_file($_FILES['image']["tmp_name"][$key], $full)) {
                       $sqlRead = "INSERT INTO slider_table (img, slider_descr) VALUES ('$idProud','$full')";
