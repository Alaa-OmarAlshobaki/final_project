                                                    ...
                                                    <div class="carousel-inner">
                                                        ...
                                                        <div class="carousel-item active">
                                                            ...
                                                            <div class="carousel-caption">
                                                                <span class="h2"> <i
                                                                        onclick="editModal('<?php echo $rw['slider_id'] ?>','<?php echo $rw['img'] ?>','<?php echo $rw['slider_descr'] ?>')"
                                                                        class="fas fa-edit "></i>
                                                                </span>
...
?>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group col-md-8 mb-4">
                            ...
                            <textarea class="form-control" id="validationCustom04" placeholder="description" value=""
                                id="desc" name="desc" required name="prod_desc" id="exampleFormControlTextarea1"
                                rows="4"></textarea>
                        ...
                        <div class="custom-file-container" data-upload-id="myFirstImage">
                            ...
                            <label class="custom-file-container__custom-file">
                                <input type="file" name="cat_img" id="cat_img" id="img"
    ...
    function editModal(id, img, desc) {
