                                                    ...
                                                    <div class="f-body">
                                                        <div class="meta-info">
                                                            <span class="user-name" data-name="Nia Hillyer">
                                                                <?php echo $row->full_name_customer ; ?></span>
                                                            <span class="user-meta-time">
                                                                <?php echo $user->count_unseen_message($row->id_customer,$user_id) ; ?></span>
                                                        </div>
                                                        <span
                                                            class="preview"><?php echo $user->fetch_is_type_status($row->full_name_customer) ; ?></span>
                                                        <span class="preview"> <?php echo $status ; ?></span>
                                                    </div>
                                                </div>
                                            </div>
