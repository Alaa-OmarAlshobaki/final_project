                            ...
                            <div class="searchable-items list">
                                <div class="items items-header-section">
                                    <div class="item-content">
                                        ...
                                        <div class="user-location ml-5">
                                            <h4 class="ml-5">Location</h4>
                                        </div>
                                        <div class="user-phone ml-5">
                                            <h4 class="ml-5">Phone</h4>
                                        </div>
                                        <div class="user-email ml-5">
                                            <h4 class="ml-5">Promo Code:</h4>
                                        </div>
                                        <div class="user-email">
                                            <h4>Stauts Code:</h4>
                                        </div>
                                ...
                                <div class="items">
                                    <div class="item-content">
                                        <div class="user-profile">
                                            <div class="n-chk align-self-center mr-2 text-center">
                                                <?php echo $i  ?>
                                            </div>
                                        ...
                                        <div class="user-location">
                                            ...
                                            <p class="usr-location mr-5" data-location="Boston, USA">
                                                <?php echo $rowCust['street_customer'] . " ,". $rowCust['city_customer']   ?>
                                            </p>
                                        </div>
                                        <div class="user-phone ">
                                            <p class="info-title">Phone: </p>
                                            <p class="usr-ph-no mr-5" data-phone="+1 (070) 123-4567">(+962)
                                                <?php echo $rowCust['phone_customer'] ?></p>
                                        </div>
                                        <div class="user-email">
                                            <p class="info-title">Promo Code: </p>
                                            <p class="usr-email-addr mr-5" data-code="#######">
                                        ...
                                        <div class="user-email">
                                            ...
                                            if( $rowCust['status_promo'] == 0 ){
                                                echo "not used";?>
                                                <span class="h3"> <i
                                                        class="fal fa-times-circle text-danger ml-3"></i></span>
                                                <?php
                                            }else{
                                                echo "used";?>
                                                <span class="h3"> <i
                                                        class="fal fa-check-circle text-success ml-3"></i></span>
                                                <?php
                                            }
                                              ?>
                                            </p>
