...
<body class="alt-menu sidebar-noneoverflow" data-spy="scroll" data-target="#navSection" data-offset="100">
    ...
    if (!file_exists("uploads/$name_category/$name_product/")) {
      ...
      foreach ($_FILES['image']['name'] as $key => $name){
        ...
        move_uploaded_file($_FILES['image']['tmp_name'][$key], "uploads/$name_category/$name_product/" . $newFilename);
        $image = "uploads/$name_category/$name_product/" . $newFilename;
       
        mysqli_query("INSERT INTO gallery (pro_id,image) values ($idProud,'$newFilename')");
    }
