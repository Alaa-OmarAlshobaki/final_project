                                     ...
                                     if($_SERVER["REQUEST_METHOD"] == "POST"){
                                        ...
                                        if(isset($_POST['modal']) AND $_POST['type']=='edit'){
                                            ...
                                            if (!file_exists('uploads/')) {
                                                ...
                                                $stripped = trim(preg_replace('/\s+/', ' ',$cat_name));

                                            }
                                            if (!file_exists("uploads/$stripped/")) {
                                                mkdir("uploads/$stripped/", 0777, true);
                                            
                                            }
                                           
                                           if(!empty($_FILES["cat_img"]["type"])){
                                          
                                               $upload_dir_img="uploads/$stripped/";
