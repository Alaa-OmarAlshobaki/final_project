                        ...
                        <div class="col-lg-12 layout-spacing">
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    <div id="circle-basic" class="">
                                        ...
                                        <section>
                                                ...
                                                <form class="needs-validation" novalidate action="javascript:void(0);>
                                                    ...
                                                    <div class="col-md-4 mb-4">
                                                        ...
                                                        <input type="text" class="form-control" name="prod_name"
                                                            id="validationCustom01" id="name" placeholder="book name"
                                                            value="" required>
                                                    ...
                                                    <div class="form-group col-md-8 mb-4">
                                                        ...
                                                        <textarea class="form-control" id="validationCustom04"
                                                            placeholder="book description" id="description" value=""
                                                            name="prod_desc" required name="prod_desc"
                                                    ...
                                                    <div class="col-md-4 mb-4">
                                                        ...
                                                        <input type="text" name="author_name" class="form-control"
                                                            id="author" id="validationCustom02"
                                                            placeholder="author name" value="" required>
                                                        <div class="valid-feedback">
                                                            good!
                                                        </div>
                                                        <div class="invalid-feedback">
                                                    ...
                                                    <div class="col-md-4 mb-4">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" id="price" class="form-control"
                                                                ...
                                                                aria-describedby="inputGroupPrepend" name="price_prod"
                                                                required>
                                                            <div class="invalid-feedback">
                                                                Please insert price
                                                            </div>
                                            ...
                                            <button id="insertProd"
                                                class="btn btn-outline-dark snackbar-bg-danger mb-2 mt-3" type="submit"
                                                name="submit"><span class="h3"><i
                                    ...
                                    <?php
                                            // insert new book according cayegory id
                                                ...
                                                <div class="custom-file-container" data-upload-id="mySecondImage">
                                                  ...
                                                  ?>
                                                    <input type="hidden" name="id_product"
                                                        value="<?php echo $row['MAX(id_product)']?>">
                                                    ...
                                                    <button name="btn_upload" type="submit"
    ...
    $(document).ready(function() {
        $("#insertProd").click(function() {
            ...
            if (name != "" && description != "" && author != "" && price != "" && quantity != "")
                ...
                $.ajax({
                    type: "GET",
                    url: "ajaxInsertProduct.php?cat_id=" + cat_id,
                    data: {
                        name: name,
