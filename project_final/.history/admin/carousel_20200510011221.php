                                                    ...
                                                    <div class="carousel-inner">
                                                        ...
                                                        <div class="carousel-item active">
                                                            ...
                                                            <div class="carousel-caption">
                                                                <span class="h2"> <i
                                                                        onclick="editModal('<?php echo $rw['slider_descr'] ?>','<?php echo $rw['slider_id'] ?>','<?php echo $rw['img'] ?>')"
                                                                        class="fas fa-edit "></i>
                                                                </span>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group col-md-8 mb-4">
                            <label for="exampleFormControlTextarea1">
                                Description</label>
                            <textarea class="form-control" id="validationCustom04" value="" id="desc" name="desc"
                                required name="prod_desc" rows="4"></textarea>
