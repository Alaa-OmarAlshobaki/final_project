<body class="alt-menu sidebar-noneoverflow">
    ...
    <head>
        ...
        k href="plugins/file-upload/file-upload-with-preview.min.css" rel="stylesheet" type="text/css" />
                                    ...
                                    <table id="style-3" class="table style-3  table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <i onclick="editModal('<?php echo $rowReadPro['category_name'] ?>','<?php echo $rowReadPro['category_dec'] ?>','<?php echo $rowReadPro['category_img'] ?>','<?php echo $id?>')"
                                                        class="fas fa-edit "></i>
                                                </td>
                                            </tr>
                                            <?php }?>
