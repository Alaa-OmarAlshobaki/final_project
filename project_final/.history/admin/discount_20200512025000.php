                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <textarea class="form-control" id="desDisc" name="desDisc"
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="desc_unit" id="desc_unit" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="desc_val" id="desc_val" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group mb-4">
