...
?>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                    ...
                    <form id="upload_multiple_images" method="POST" enctype="multipart/form-data">
                        <div class="form-group col-md-8 mb-4">
                            ...
                            <textarea class="form-control" id="validationCustom04" placeholder="description" value=""
                                name="desc" required name="prod_desc" id="exampleFormControlTextarea1"
                                rows="4"></textarea>
                ...
                <div class="modal-footer md-button">
                    ...
                    <button type="button" id="type_btn" type="submit" name="modal" class="btn btn-primary">Save</button>
                </div>
            </div>
        </div>
    </div>
    ...
    function editModal(name, desc, img) {
