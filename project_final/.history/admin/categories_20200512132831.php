                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                    ...
                                                    if(!isset($rowReadDis['discount_value'])){
                                                        ...
                                                        echo "No Discount";
                                                        echo "<i onclick='editDiscount(".echo $rowReadDis['discount_value'] .")' class='fas fa-edit'>";
                                                        ?>

                                                <i onclick="editDiscount('<?php editDiscount?>')"
                                                    class="fas fa-edit "></i>
                                                <?php
                                                }else{
                                                    echo $rowReadDis['discount_value'] ."<i class='fal fa-percentage text-danger'></i>" ;
                                                    ?>
                                                <i onclick="editDiscount('<?php echo $rowReadDis['discount_value'] ?>')"
                                                    class="fas fa-edit "></i>
                                                <?php
                                                } ?>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <i onclick="editModal('<?php echo $rowRead['category_name'] ?>','<?php echo $rowRead['category_dec'] ?>','<?php echo $rowRead['category_img'] ?>','<?php echo $id_category?>')"
                                                    class="fas fa-edit "></i>
    ...
    <div id="faderightModal" class="modal animated fadeInRight custo-fadeInRight" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="modal-text">Nulla imperdiet sed ipsum non lacinia. Duis accumsan egestas nulla, vel
                        commodo orci tempus quis. Fusce malesuada felis nec vehicula luctus. Proin luctus sapien nunc,
                        quis varius dui gravida quis. Sed eget elit a augue porta elementum ut nec nibh. Morbi non dolor
                        ac quam commodo interdum.</p>
                </div>
                <div class="modal-footer md-button">
                    <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i> Discard</button>
