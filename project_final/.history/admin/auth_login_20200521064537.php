...
//start session
session_start();
require_once 'C:\xampp\htdocs\project_final\admin\chat\class\user.php';
//include conniction
...
<head>
    ...
    <title>Login dashboard pustok . </title>
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="">Log In to <a href="index.html"><span class="brand-name h2">pustok .
                                </span></a>
                        </h1>
