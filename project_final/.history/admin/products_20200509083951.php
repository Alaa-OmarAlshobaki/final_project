<body class="alt-menu sidebar-noneoverflow">
                                    ...
                                    <table id="style-3" class="table style-3  table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="checkbox-column text-center"> <?php 
                                                 $quyEdit="SELECT * FROM gallery WHERE pro_id=$id";
                                                 $resEdit=mysqli_query($conn,$quyEdit);
                                                 while($rwEdit=mysqli_fetch_assoc($resEdit)){
                                                     $idImg=$rwEdit['id'];
                                                     $image=$rwEdit['image'];
                                                 }
                                                  ?> <i onclick="editGalModal('<?php echo $idImg ?>','<?php echo $image ?>','<?php echo $id ?>')"
                                                        class="fas fa-edit "></i>
                                                </td>
            ...
            <div class="modal-content">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="custom-file-container" id="img" data-upload-id="mySecondImage">
                            <label>Update book images <a href="javascript:void(0)"
    ...
    function editGalModal(image, idImg, id) {
