<body class="alt-menu sidebar-noneoverflow">
    ...
    <div class="main-container sidebar-closed sbar-open" id="container">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <div id="carouselExampleIndicators" style="width: 50%;"
                                                        ...
                                                        <div class="carousel-inner">
                                                            ...
                                                            <div class="carousel-item active">
                                                                ...
                                                                <div class="carousel-caption">
                                                                    ...
                                                                    <span class="h2"><i
                                                                            onclick="editGalModal('<?php echo $idImg ?>','<?php echo $id ?>')"
                                                                            class="fas fa-edit "></i>
                                                                    </span>
                                                ...
                                                <td class="text-center">
                                                    <button class="btn btn-dark mb-2 mr-2 rounded-circle"><i
                                                            onclick="editModal('<?php echo $row['category_name'] ?>','<?php echo $row['prod_name'] ?>','<?php echo$row['prod_desc'] ?>','<?php echo$row['author_name']  ?>','<?php echo$row['product_qty'] ?>','<?php echo $id ?>','<?php echo $row['id'] ?>')"
                                                            class="fas fa-edit "></i>
        ...
        if(isset($_POST['delete'])){
            ...
            $queryD="delete from product where id_product = $cat_id";
    ...
    function editGalModal(idImg, id) {
