...
<body>
                        ...
                        <div class="product-card">
                            ...
                            <div class="product-card--body">
                                ...
                                <div class="price-block">
                                    ...
                                    <del class="price-old">£51.20</del>
                                    <span
                                        class="price-discount"><?php $date=$rowdiscount['end_disc'] ; echo date("Y-m-d H:00:00",strtotime($date)); ?></span>
                                </div>
                                <div class="count-down-block">
                                    <div class="product-countdown" id="demo" data-countdown="">
                                    </div>
                        ...
                        <div class="product-card card-style-list">
                            ...
                            <div class="product-card--body">
                                <div class="product-header">
                                    ...
                                    <h3><a href="product-details.html"><?php echo $catRow['category_name']  ?></a></h3>
                                </div>
                                <div class="price-block">
                                    <span class="price">£51.20</span>
                                    <del class="price-old">£51.20</del>
                ...
                <div class="row space-db--30">
                    ...
                    <div class="col-lg-4 mb--30">
                        <div class="promo-wrapper promo-type-two ">
                            ...
                            <div class="promo-text">
                                <div class="promo-text-inner">
                                    <?php $queryLastProd="SELECT MAX(id_product) FROM product
                                                      INNER JOIN categorey
                                                      ON product.id_cat=category.id" ;
                                       $resLastProd=mysqli_query($conn,$queryLastProd);
                                       $rowLastProd=mysqli_fetch_assoc($resLastProd) ?>
                                    <span class="d-block price"> <?php echo $rowLastProd['price_prod'] ?></span>
                                    <h2><?php echo $rowLastProd['category_name'] ?> <br>
                                        <?php echo $rowLastProd['prod_name'] ?></h2>
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    ...
                                    <div class="hover-contents">
                                        ...
                                        <div class="hover-btns">
                                            <a href="cart.php?id=<?php echo $rowWdiscount['id_product'] ?>"
                                                class="single-btn">
                                                <i class="fas fa-shopping-basket"></i>
                                            </a>
                                ...
                                <div class="price-block">
                                    <span class="price"><?php echo $rowWdiscount['price_prod']  ?>JOD</span>
                                    <del class="price-old"><?php echo $rowWdiscount['price_prod']*50/100 ?>JOD</del>
    ...
    var countDownDate = new Date("May 22, 2020 15:37:25").getTime();
