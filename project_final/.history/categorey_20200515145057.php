                            ...
                            <div class="single-block">
                                <div class="home-right-block bg-white">
                                    <div class="sb-custom-tab text-lg-left text-center">
                                        ...
                                        $idCate=$_GET['id'];
                                        $i=0;
                                         $allProd="select * from product where id_cat= $idCate" ;
                                         $reCate=mysqli_query($conn,$allProd);
                                         while($rowAll=mysqli_fetch_assoc($reCate)){
                                             $i++ ?>
                                            <li class="nav-item">
                                                <a class="nav-link active" id="shop-tab2" data-toggle="tab"
                                                    href="#shop<?php echo $i ?>" role="tab" aria-controls="shop2"
                                                    aria-selected="true">
                                                    <?php echo $rowAll['prod_name'] ?>
                                                </a>
                                            </li>
                                            <?php } ?>
                                            <!-- <li class="nav-item">
                                        ...
                                        $idC=$_GET['id'];
                                        $count=1;
                                         $viewSec="select * from product where id_cat=$idC";
                                         $reViwSec=mysqli_query($conn,$viewSec);
                                         while($rowViewSec=mysqli_fetch_assoc($reViwSec)) 
                                         if($count == 1) {
                                              ?>
                                            <div class="tab-pane show active" id="shop<?php echo $count ?>"
                                                role="tabpanel" aria-labelledby="shop-tab2">
                                            ...
                                            ?>
                                            <div class="tab-pane" id="shop<?php echo $count ?>" role="tabpanel"
