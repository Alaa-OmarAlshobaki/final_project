                        ...
                        <div class="col-lg-3">
                          ...
                          $queryProd ="SELECT * FROM product
                                        ...
                                        <li class="cat-item has-children">
                                            <a href="product.php?id=<?php echo $row['id_product'] ?>"><?php echo $rowReadSec['category_name'] ?>
                                            </a>
                                            <!-- <ul class="sub-menu"> -->
                            ...
                            <nav class="category-nav   ">
                                <div>
                                    ...
                                    <ul class="category-menu">
                                        ...
                                        ?>
                                        <li class="cat-item has-children">
                                            <a href="product.php?id=<?php echo $rowProd['id_product'] ?>"><?php echo $rowReadSec['category_name'] ?>
                                            </a>
                                            <!-- <ul class="sub-menu">
                                                <li><a href="#">Bags & Cases</a></li>
                                                <li><a href="#">Binoculars & Scopes</a></li>
