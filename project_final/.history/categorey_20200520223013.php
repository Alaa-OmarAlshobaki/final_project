                                           ...
                                           while($rowReadSec=mysqli_fetch_assoc($resultReadSec))
                                           {
                                            ...
                                            <li class="cus-col-25">
                                                <h3 class="menu-title"><a
                                                        href="categorey.php?idProd=<?php echo $rowReadSec['id'] ?>">
                                                        <?php echo $rowReadSec['category_name'] ?>
                                                    </a></h3>
                                    ...
                                    ?>
                                                ...
                                                if(isset( $rowQ['id_dis'])){
                                                  ?>
                                                    ...
                                                    ?>
                                                                <span
                                                                    class="price"><?php echo $rowLast['price_prod']  ?>
                                                                    JOD</span>

                                                                <?php }
                                                    
                                                    $id= $rowLast['id_product'] ;
                                                        ...
                                                        <div class="product-card card-style-list">
                                                            ...
                                                            if(isset( $rowQ['id_dis'])){
                                                              ?>
                                                                ...
                                                                ?>
                                                                    <span
                                                                        class="price"><?php echo $rowLast['price_prod']  ?>JOD</span>
                                                                    <?php }
                                                           $idAll= $row['id_product'] ;
