                                           ...
                                           while($rowReadSec=mysqli_fetch_assoc($resultReadSec))
                                           {
                                            ...
                                            <li class="cus-col-25">
                                                <h3 class="menu-title"><a
                                                        href="product.php?id=<?php echo $rowReadSec['id'] ?>"><?php echo $rowReadSec['category_name'] ?>
                                                    </a></h3>
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <?php
                                           ...
                                           while($rowReadSec=mysqli_fetch_assoc($resultReadSec))
                                           {
                                            ...
                                            ?>
                                        <li class="menu-item-has-children">
                                            <a href="product.php?id=<?php echo $rowReadSec['id'] ?>"><?php echo $rowReadSec['category_name'] ?>
                                            </a>
                                            <!-- <ul class="sub-menu">
                                                <li><a href="blog.html">Full Widh (Default)</a></li>
                                                <li><a href="blog-left-sidebar.html">left Sidebar</a></li>
