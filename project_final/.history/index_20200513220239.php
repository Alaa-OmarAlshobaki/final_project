...
<body>
    <div class="site-wrapper" id="top">
        ...
        <section class="section-margin">
            ...
            inner join category on cat_discount_pro.id_cat = category.id 
             inner join discount on cat_discount_pro.id_dis = discount.discount_value 
              ...
              ?>
                    <div class="single-slide">
                        <div class="product-card">
                            <div class="product-header">
                                <a href="#" class="author">
                                    <?php echo $rowWdiscount['category_name']  ?>
                                </a>
                                <h3><a style="max-height: 60px;"
                                        href="product-details.html"><?php echo $rowWdiscount['category_dec']  ?>
                                    </a></h3>
                            </div>
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img src="admin/uploads/<?php echo $rowWdiscount['category_img']  ?>" alt="">
                                    <div class="hover-contents">
                                        <a href="product-details.html" class="hover-image">
                                            <img src="admin/uploads/<?php echo $rowWdiscount['category_img']  ?>"
                                                alt="">
                                        </a>
                                        <div class="hover-btns">
                                            <a href="cart.html" class="single-btn">
                                ...
                                <div class="price-block">
                                    <span class="price"><?php echo $rowWdiscount['disc_desc'] ?></span>
