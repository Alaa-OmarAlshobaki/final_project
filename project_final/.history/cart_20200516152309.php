                ...
                <div class="container">
                    ...
                    <div class="row">
                                ...
                                <div class="cart-table table-responsive mb--40">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <!-- Product Row -->
                                            <?php     foreach ($prodctCard as $key => $singleProCard) { 
                                            ...
                                            <tr>
                                                <td class="pro-remove"><a
                                                        href="deleteprocard.php?idpro=<?php echo $singleProCard['id_product']  ?>"><i
                                                            class="far fa-trash-alt"></i></a>
                                                </td>
                                                <?php 
												$prod=$singleProCard['id_product'];
                                                ...
                                                <td class="pro-title"><?php echo $singleProCard['prod_name'] ?></td>
                                                <td class="pro-price"><span>
												   ...
												   $rowQ=mysqli_fetch_assoc($rs);
												   if(isset( $rowQ['id_dis'])){
													 echo $singleProCard['price_prod']-($singleProCard['price_prod']*$rowQ['id_dis']/100) ;
												   } else {
													 echo $singleProCard['price_prod'] ;
                        ...
                        <?php
							...
							$CUS=$customer;
							echo "oekwokewoidwoi$CUS . $CODE jw";
							die();
							$queryChec="SELECT promo_code,	status_promo,id_customer FROM customer_table
										 WHERE status_promo = 0
										 AND promo_code=$CODE
										 AND id_customer=$CUS";
							$resChec=mysqli_query($conn,$queryChec);
							if($rowChec=mysqli_fetch_assoc($resChec)){
