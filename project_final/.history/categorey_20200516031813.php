                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3">
                          ...
                          $queryProd ="SELECT * FROM product
                                        ...
                                        ?>
                                        <li class="cat-item ">
                                            <a href="product-details.php?id=<?php echo $rowProd['id_product'] ?>"><?php echo $rowProd['prod_name'] ?>
                                            </a>
                            ...
                            <nav class="category-nav   ">
                                <div>
                                    ...
                                    <ul class="category-menu">
                                        ...
                                        ?>
                                        <li class="cat-item ">
                                            <a href="product-details.php?id=<?php echo $row['id_product'] ?>"><?php echo $row['prod_name'] ?>
                                            </a>
                                  ...
                                  where product.id_cat = $arr
                                    ...
                                    ?>
                                                ...
                                                if(isset( $rowQ['id_dis'])){
                                                  ?>
                                                                <span
                                                                    class="price"><?php $rowLast['price_prod']-(echo $rowLast['price_prod']*$rowQ['id_dis']/100)  ?>
                                                                    JOD</span>
                                                                <del
