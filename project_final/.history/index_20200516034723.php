...
session_start();
foreach ($_SESSION['prod_card'] as $prod_id) {
                                    ...
                                    <div class="cart-block">
                                        <div class="cart-total">
                                            <span class="text-number">
                                                <?php echo count($_SESSION['prod_card'])  ?>
                                            </span>
                                        ...
                                        <div class="cart-dropdown-block">
                                            ...
                                            <div class="content">
                                                ...
                                                <p class="price"><span class="qty">1 ×</span> <?php $idP= $singleProCard['id_product'] ;
                                                $q="select * from cat_discount_pro where id_pro = $idP";
                                                $rs=mysqli_query($conn,$q);
                                                $rowQ=mysqli_fetch_assoc($rs);
                                                if(isset( $rowQ['id_dis'])){
            ...
            <div class="off-canvas-inner">
                ...
                <div class="off-canvas-bottom">
                    <div class="contact-list mb--10">
                        ...
                        <a href="" class="sin-contact"><i class="fas fa-envelope"></i>alaaomaralshobaki@gmail.com</a>
                    </div>
                            ...
                            <div class="single-slide">
                                <div class="product-card">
                                    <div class="product-header">
                                        ...
                                        <h3><a style="max-height:20px"
                                                href="product-details.php?id=<?php echo $rowLast['id_product']  ?>">
                            ...
                            <div class="single-slide">
                                <div class="product-card">
                                    <div class="product-header">
                                        ...
                                        <h3><a style="max-height:20px"
                                                href="product-details.php?id=<?php echo $rowMax['id_product'] ?>">
            ...
            while($rowdiscount=mysqli_fetch_assoc($resdiscount)){
              ?>
                <div class="single-slide">
                    <div class="product-card">
                        <div class="product-header">
                            <a href="product-details.php?id=<?php echo $rowdiscount['id_product'] ?>" class="author">
                                ...
                                <div class="product-card card-style-list">
                                    ...
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            ...
                                            <h3><a href="product-details.php?id=<?php echo $rowAuth['id_product'] ?>">
            ...
            while($rowWdiscount=mysqli_fetch_assoc($resWdiscount)){
              ?>
                <div class="single-slide">
                    <div class="product-card">
                        <div class="product-header">
                            <a href="product-details.php?id=<?php echo $rowWdiscount['id_product'] ?>" class="author">
