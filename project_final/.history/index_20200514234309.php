...
<body>
                                                ...
                                                <div class="hover-contents">
                                                    ...
                                                    <div class="hover-btns text-center  single-btn">
                                                        ...
                                                        <div class="single-btn">
                                                            <i onclick="editModal('<?php echo $rowMax['id_product'] ?>','<?php echo $rowMax['prod_name'] ?>','<?php echo $rowMax['image'] ?>',' <?php echo $rowMax['category_name']   ?>')"
                                                                class="fas fa-eye"></i>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script>
    function editModal(id, name, img, cat) {
