...
<body>
                        ...
                        <div class="product-card">
                            ...
                            <div class="product-card--body">
                                ...
                                <div class="count-down-block">
                                    <div class="product-countdown" data-countdown="<?php echo date("Y/m/d")  ?>">
                                    </div>
                                    <input type="hidden" id="date" value="<?php echo $rowdiscount['end_disc']  ?>">
                                    <div id="demo"></div>
                                </div>
                            </div>
                        </div>
    ...
    val date = document.getElementById('#date').val();
