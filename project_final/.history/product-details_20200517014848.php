                                        ...
                                        <div class="cart-total">
                                            ...
                                            // }
                                                  foreach ($prodctCard as $key => $singleProCard) {
                                                    ...
                                                    $q="select * from cat_discount_pro where id_pro = {$singleProCard[0]['id_product']}";
                                        ...
                                        <div class="cart-dropdown-block">
                                            <?php
                                                ...
                                                foreach ($prodctCard as $key => $singleProCard) {
                                                    ...
                                                    for($i=0;$i<sizeof($singleProCard);$i++){
                                                    // print_r( $singleProCard[0]['id_product']);
                                                    $q="select * from cat_discount_pro where id_pro = $singleProCard[0]";
                                                    $rs=mysqli_query($conn,$q);
                                                    $rowQ=mysqli_fetch_assoc($rs);
                                                    if(isset( $rowQ['id_dis'])){
                                                $total+= $singleProCard['price_prod']-($singleProCard[0]['price_prod']*$rowQ['id_dis']/100);
                                                    }else{
                                                        $total+= $singleProCard[0]['price_prod'];  
                                                    }
                                                # code...
