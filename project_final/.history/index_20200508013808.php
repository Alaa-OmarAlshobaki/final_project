                                ...
                                <ul class="main-menu menu-right ">
                                    ...
                                    <li class="menu-item has-children mega-menu">
                                        ...
                                        <ul class="sub-menu four-column">
                                            ...
                                            <?php
                                            $queryReadSect="SELECT * FROM product
                                            INNER JOIN category
                                            ON product.id_cat = category.id";
                                            $resultReadSec=mysqli_query($queryReadSect);
                                           while($rowReadSec=mysqli_fetch_assoc($resultReadSec))
                                           {
                                            ...
                                            <li class="cus-col-25">
                                                <h3 class="menu-title"><a
                                                        href="javascript:void(0)"><?php echo $rowReadSec['category_name'] ?>
                                                    </a></h3>
                                                <ul class="mega-single-block">
                                                    <li><a
                                                            href="shop-grid.html"><?php echo $rowReadSec['prod_name']  ?></a>
                                                    </li>
