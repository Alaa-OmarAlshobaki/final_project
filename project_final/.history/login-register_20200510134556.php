...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($_POST["phone_customer"])) {
    ...
    $phoneErr = test_input($_POST["phone_customer"]);
  }

  if (empty($_POST["password_customer"])) {
    $passErr = "Phone is required";
  } else {
    $passErr = test_input($_POST["password_customer"]);
  }

  if (empty($_POST["street_customer"])) {
    $addErr = "address is required";
  } else {
    $addErr = test_input($_POST["street_customer"]);
  }
  if (empty($_POST["city_customer"])) {
    $addressErr = "address is required";
  } else {
    $addressErr = test_input($_POST["city_customer"]);
  }
}
