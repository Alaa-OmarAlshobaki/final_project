...
<body>
    ...
    ===================================== -->
        <section class="section-margin">
            ...
            inner join category on product.id_cat = $id
                                    ...
                                    <div class="single-slide">
                                        <div class="product-card">
                                            ...
                                            <div class="product-card--body">
                                                ...
                                                if(isset( $rowQ['id_dis'])){
                                                  ?>
                                                    <span class="price"><?php echo $rowdiscount['price_prod']*50/100  ?>
                                                        JOD</span>
                                                    <del
                     ...
                     where cat_discount_pro.id_cat = $id_D
                       ...
                       ?>
                                                ...
                                                if(isset( $rowQ['id_dis'])){
                                                  ?>
                                                                <span
                                                                    class="price"><?php echo $rowDiscount['price_prod']*50/100  ?>
                                                                    JOD</span>
                                                                <del
                                                                    class="price-old"><?php echo $rowDiscount['price_prod']  ?>JOD</del>
                                                ...
                                                ?>
                                                                ...
                                                                <span class="price-discount"> <?php $i= $rowDiscount['id_product'] ;
                            ...
                            {"breakpoint":320, "settings": {"slidesToShow": 1} }
                                                ...
                                                <?php 
                                    $queryLast="select * from gallery INNER JOIN product ON gallery.pro_id = product.id_product inner join category where product.id_cat=$id order by id_product desc limit 20";
