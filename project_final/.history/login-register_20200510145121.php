                            ...
                            <div class="login-form">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-12 mb--15">
                                        ...
                                        <span
                                            class="text-danger"><?php if (isset($name_error)) echo $name_error; ?></span>
                                    </div>
                                ...
                                <div class="col-12 mb--20">
                                    ...
                                    <input class="mb-0 form-control" name="phone_customer" type="text" id="phone"
                                        placeholder="Enter Your Phone Number Here.." required="">
                                    <span
                                        class="text-danger"><?php if (isset($mobile_error)) echo $mobile_error; ?></span>
                                </div>
                                <div class="col-lg-6 mb--20">
                                    <label for="password">Password</label>
                                    <input class="mb-0 form-control" type="password" name="password_customer"
                                ...
                                <div class="col-lg-6 mb--20">
                                    <label for="password">Password</label>
                                    <input class="mb-0 form-control" type="password" name="cpassword" id="password"
                                ...
                                <div class="col-lg-6 mb--20">
                                    ...
                                    <span class="text-danger"><?php if (isset($str_error)) echo $name_error; ?></span>
                                </div>
                                <div class="col-lg-6 mb--20">
                                    <label for="address">City Address</label>
                                    <input class="mb-0 form-control" type="text" name="city_customer" id=""
                                        placeholder="Enter your City Address">
                                    <span class="text-danger"><?php if (isset($city_error)) echo $name_error; ?></span>
                                </div>
                                <div class="col-md-12">
                                    <a href="#" type="submit" name="submit" class="btn btn-outlined">Register</a>
                                </div>
                            </div>
                    </div>
                    </form>
...
if (isset($_POST['submit'])) {
	$name = mysqli_real_escape_string($conn, $_POST['full_name_customer']);
	$str = mysqli_real_escape_string($conn, $_POST['street_customer']);
	$city = mysqli_real_escape_string($conn, $_POST['city_customer']);
	$email = mysqli_real_escape_string($conn, $_POST['email_customer']);
	$mobile = mysqli_real_escape_string($conn, $_POST['phone_customer']);
	$password = mysqli_real_escape_string($conn, $_POST['password_customer']);
	$cpassword = mysqli_real_escape_string($conn, $_POST['cpassword']); 
	if (!preg_match("/^[a-zA-Z ]+$/",$name)) {
		$name_error = "Name must contain only alphabets and space";
	}
	if (!preg_match("/^[a-zA-Z ]+$/",$str)) {
		$str_error = "street must contain only alphabets and space";
	}
	...
	if (!$error) {
		if(mysqli_query($conn, "INSERT INTO admin(name, email, mobile ,password) VALUES('" . $name . "', '" . $email . "', '" . $mobile . "', '" . md5($password) . "')")) {
