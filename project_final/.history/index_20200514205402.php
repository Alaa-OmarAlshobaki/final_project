                                    ...
                                    <div class="product-card">
                                        <div class="product-header">
                                            ...
                                            <h3><a style="max-height: 20px;"
                                                    href="product-details.html"><?php echo $rowMax['prod_name']   ?></a>
                                            </h3>
                                        </div>
                                            ...
                                            <div class="card-image">
                                                ...
                                                <div class="hover-contents">
                                                    <a href="product-details.html" class="hover-image">
                                                        <!-- <img src="admin/<?php //echo $rowMax['image']   ?>" alt=""> -->
                                                    </a>style="background-color: #00000021 !important;"
                                                    class="hover-btns text-center">
                                        ...
                                        <div class="price-block">
                                            <span class="price"><?php echo $rowMax['price_prod'] *50/100  ?>JOD</span>
                            ...
                            <div class="single-slide">
                                <div class="product-card">
                                    <div class="product-header">
                                        ...
                                        <h3><a style="max-height:20px" href="product-details.html">
                            ...
                            <div class="single-slide">
                                <div class="product-card card-style-list">
                                    ...
                                    <div class="product-card--body">
                                        ...
                                        <div class="price-block">
                                            <span class="price"><?php echo $rowAuth['price_prod'] *50/100  ?>JOD</span>
