...
<body>
    <div class="site-wrapper" id="top">
        ...
        <section class="section-margin">
            ...
            inner join gallery on gallery.pro_id = product.id_product limit 1
            where  id_dis=50
                    ...
                    <div class="single-slide">
                        <div class="product-card">
                            <div class="product-header">
                                ...
                                <h3><a href="product-details.php?id=<?php echo $rowdiscount['id_product'] ?>"><?php echo $rowdiscount['prod_name'] ?>
                                    </a>
                                </h3>
                            </div>
                            <div class="product-card--body">
