                                    ...
                                    <div class="checkout-slidedown-box" id="quick-cupon">
                                        <form action="./">
                                            <div class="checkout_coupon">
                                                ...
                                                <input type="submit" class="btn btn-outlined mt-5" name="apply_coupon"
                                                    value="Apply code">
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <div id="billing-form" class="mb-40">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-12 mb--20">
                                                ...
                                                <input type="text" value="<?php echo $rowCus['full_name_customer']  ?>"
                                                    placeholder="First Name">
                                            </div>

                                            <div class="col-md-6 col-12 mb--20">
                                                <label>Email Address*</label>
                                                <input type="email" value="<?php echo $rowCus['email_customer']  ?>"
                                            ...
                                            <div class="col-md-6 col-12 mb--20">
                                                <label>City*</label>
                                                <input type="text" value="<?php echo $rowCus['city_customer']  ?>"
											...
											foreach ($prodctCard as $key => $singleProCard) {
												...
												?>
                                                    ...
                                                    <li><span class="left"><?php echo $singleProCard[0]['prod_name']  ?>
                                                            X <?php echo $singleProCard[1]  ?></span>

                                                        <span class="right"> <?php   if(isset( $rowQ['id_dis'])){
