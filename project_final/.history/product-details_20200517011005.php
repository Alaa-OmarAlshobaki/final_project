                                        ...
                                        <div class="cart-total">
                                            ...
                                            // }
                                                  foreach ($prodctCard as $key => $singleProCard) {
                                                    ...
                                                    foreach ($prodctCard as $key2 => $ProCard) {
                                                        // foreach ($singleProCard[$i] as $key => $ProCard) {
                                                        // print_r($ProCard['id_product']);
                                                    ...
                                                    $idP =$singleProCard[$i]['id_product'];
                                                    $q="select * from cat_discount_pro where id_pro = $idP";
                                                    $rs=mysqli_query($conn,$q);
                                                    $rowQ=mysqli_fetch_assoc($rs);
                                                    if(isset( $rowQ['id_dis'])){
                                                    $total+= $singleProCard[$i]['price_prod']-($singleProCard[$i]['price_prod']*$rowQ['id_dis']/100);
                                                    }else{
                                                        $total+= $singleProCard[$i]['price_prod'];
                                                    }
