                        ...
                        <div class="product-card">
                            ...
                            <div class="product-card--body">
                                ...
                                <div class="count-down-block">
                                    <div class="product-countdown" id="demo" data-countdown="<?php $('#timer').countdown({
    until: '<?php echo date("12:00:00"); ?>' // change this, obviously
}); ?>">
                                    </div>
            ...
            <div class="container">
                ...
                <div class="product-list-slider slider-two-column product-slider multiple-row sb-slick-slider slider-border-multiple-row"
                    ...
                    <div class="single-slide">
                        <div class="product-card card-style-list">
                            <div class="card-image">
                                <img src="admin/<?php echo $catRow['category_img']  ?>" alt="">
                            </div>
                            <div class="product-card--body">
                                <div class="product-header">
                                    <a href="#" class="author">
            ...
            <div class="container">
                <div class="section-title section-title--bordered">
                    <div class="promo-section-heading h3 text-white">
                        Deal of the day up to 50% off Special offer
                    </div>
                </div>
        ...
        <section class="section-margin">
            ...
            ?>
                    <div class="single-slide">
                        <div class="blog-card">
                            <div class="image">
                                <img src="admin/<?php echo $catRowDisc['category_img'] ?>" alt="">
                            </div>
                            <div class="content">
                                <div class="content-header">
                                    ...
                                    <h3 class="title"><a
                                            href="blog-details.html"><?php echo $catRowDisc['category_name'] ?></a>
                                    </h3>
                                </div>
