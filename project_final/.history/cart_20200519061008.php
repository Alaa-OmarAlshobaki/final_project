										  ...
										  if(empty($prodctCard)){
                                            ...
                                            <tr>
                                                <td class="pro-remove"><a
                                                        href="deleteprocard.php?idProd=<?php echo $singleProCard[0]['id_product']  ?>"><i
								...
								if(empty($prodctCard)){
									...
									foreach ($prodctCard as $key => $singleProCard) {
                                      ...
                                      $idP=$singleProCard[0]['id_product'];
										...
										$rowQ=mysqli_fetch_assoc($rs);
										if(isset( $rowQ['id_dis'])){
										$singleProCard[1]* ($singleProCard[0]['price_prod']-($singleProCard[0]['price_prod']*$rowQ['id_dis']/100));
										}else{
										  $singleProCard[1]*$singleProCard[0]['price_prod'];
										}
