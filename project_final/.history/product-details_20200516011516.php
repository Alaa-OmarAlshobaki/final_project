                                            ...
                                            <span class="price">
                                                <?php
                                                  foreach ($prodctCard as $key => $singleProCard) {
                                                    ...
                                                    $total+= $singleProCard['price_prod']*$rowQ['id_dis']/100;
                                                    }else{
                                            ...
                                            <div class=" single-cart-block ">
                                                <div class="cart-product">
                                                    <a href="product-details.html" class="image">
                                                        <img src="admin/<?php echo $singleProCard['image']?>" alt="">
                                                    </a>
                                                    <div class="content">
                                                        <h3 class="title"><a
                                                ...
                                                if(isset( $rowQ['id_dis'])){
                                                  ?>
                                                            <span
                                                                class="price"><?php echo $singleProCard['price_prod']*$rowQ['id_dis']/100  ?>
                                                                JOD</span>
                                                            <del
                                                ...
                                                ?>
                                                        ...
                                                        <a href="deleteprocard.php?idpro=<?php echo $singleProCard['pro_id']  ?>"
                      ...
                      ?>
                            ...
                            <div class=" price-block">
                                <?php 
                                                ...
                                                if(isset( $rowQ['id_dis'])){
                                                  ?>
                                <span class="price"><?php echo $rowReturn['price_prod']*$rowQ['id_dis']/100  ?>
                                    JOD</span>
                                ...
                                <form method="POST" action="">
                                    <div class="add-to-cart-row mt-5 pt-5">
                                        <div class="count-input-block">
                                            ...
                                            <input type="number" name="numBook" class="form-control text-center"
                                                value="1">
                                        </div>
