                                        ...
                                        <div class="cart-total">
                                            ...
                                            if(empty($prodctCard)){
                                                ...
                                                foreach ($prodctCard as $key => $singleProCard) {
                                                    ...
                                                    $total+= $singleProCard[1]* ($ProCard['price_prod']-($ProCard['price_prod']*$rowQ['id_dis']/100));
                                                    }else{
                                                        $total+=  $singleProCard[1]*$ProCard['price_prod'];
                                                    }
              ...
              "focusOnSelect": true
                        ...
                        <div class="tab-content space-db--20" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="tab-2" role="tabpanel" aria-labelledby="tab2">
                                <div class="review-wrapper">
                                    ...
                                    <?php
                                      $return=$_GET['idProd'];
                                     $queryComment ="SELECT * FROM comment_table
                                     where id_product=$return";
                    ...
                    $queryInsert="INSERT INTO comment_table (name,email,comment,id_product,date)
                               ...
                               if($reInsert=mysqli_query($conn,$queryInsert))
                                 { 
                                     direct("product-details.php?idProd=".$rowReturn['id_product']);
                                    }else{
                                        echo "error";
                                        die();
