                ...
                <div class="sb-custom-tab">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane show active" id="shop" role="tabpanel" aria-labelledby="shop-tab">
                            ...
                            {"breakpoint":320, "settings": {"slidesToShow": 1} }
                                ...
                                <?php 
                                    $queryMax ="select * from cat_discount_pro  inner join product on cat_discount_pro.id_pro = product.id_product inner join gallery on gallery.pro_id = product.id_product order by id_dis desc limit 20";
                                    ...
                                    <div class="product-card">
                                        ...
                                        <div class="product-card--body">
                                            <div class="card-image">
                                                <img src="admin/<?php echo $rowMax['image']   ?>
                    ...
                    <div class="tab-pane" id="men" role="tabpanel" aria-labelledby="men-tab">
                        <div class="product-slider multiple-row  slider-border-multiple-row  sb-slick-slider"
                            ...
                            <?php 
                                    $queryLast="select * from product order by id_product desc limit 20";
                    ...
                    <div class="tab-pane" id="woman" role="tabpanel" aria-labelledby="woman-tab">
                        <div class="product-slider multiple-row  slider-border-multiple-row  sb-slick-slider"
                            ...
                            <?php 
                                    $queryMax ="select * from order_items order by quantity desc limit 20";
                                    $resMax=mysqli_query($conn,$queryMax);
                                    while($rowMax=mysqli_fetch_assoc($resMax))
                                    {
                                        ?>
