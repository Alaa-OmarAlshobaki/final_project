...
$nameErr = $emailErr = $phoneErr = $passErr = $addErr = $addressErr ="";
$name = $email = $phone = $pass = $add = $address =  "";

if ($_SERVER["REQUEST_METHOD"] == "POST") {
  if (empty($_POST["full_name_customer"])) {
    $nameErr = "Name is required";
  } else {
    $name = test_input($_POST["full_name_customer"]);
  }

  if (empty($_POST["email_customer"])) {
    $emailErr = "Email is required";
  } else {
    $email = test_input($_POST["email_customer"]);
  }

  if (empty($_POST["phone_customer"])) {
    $phoneErr = "Phone is required";
  } else {
    $phone = test_input($_POST["phone_customer"]);
  }

  if (empty($_POST["password_customer"])) {
    $passErr = "Phone is required";
  } else {
    $pass = test_input($_POST["password_customer"]);
  }

  if (empty($_POST["street_customer"])) {
    $addErr = "address is required";
  } else {
    $add = test_input($_POST["street_customer"]);
  }
  if (empty($_POST["city_customer"])) {
    $addressErr = "address is required";
  } else {
    $address = test_input($_POST["city_customer"]);
  }
}
                            ...
                            <div class="login-form">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-12 mb--15">
                                        ...
                                        <input class="mb-0 form-control" type="text" name="	full_name_customer	"
