                                        ...
                                        <div class="myaccount-content">
                                            ...
                                            <div class="account-details-form">
                                                ...
                                                if(isset($_POST['update'])){
                                                    ...
                                                    if($row=mysqli_fetch_assoc($resChec)){
                                                        $password=$row['password_customer'];
                                                        if($password === $pass){
                                              
                                                 $queryUpdate="UPDATE `customer_table` SET `id_customer`=[value-1],`full_name_customer`=[value-2],`phone_customer`=[value-3],`email_customer`=[value-4],`street_customer`=[value-5],`city_customer`=[value-6],`password_customer`=[value-7],`promo_code`=[value-8],`status_promo`=[value-9] WHERE 1"
