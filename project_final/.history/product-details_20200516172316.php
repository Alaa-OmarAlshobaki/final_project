                                        ...
                                        <div class="cart-dropdown-block">
                                            ...
                                            <div class=" single-cart-block ">
                                                ...
                                                if(isset( $rowQ['id_dis'])){
                                                  ?>
                                                            <span
                                                                class="price"><?php echo  $quantity * $singleProCard['price_prod']-($singleProCard['price_prod']*$rowQ['id_dis']/100) ?>
                                                                JOD</span>
                                                            <del
                                                                class="price-old"><?php echo  $quantity *$singleProCard['price_prod']  ?>JOD</del>
