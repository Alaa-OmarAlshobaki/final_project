                                                ...
                                                <div class="row">
                                                    <div class="col-xl-2 col-lg-12 col-md-4">
                                                        <div class="upload mt-4 pr-md-4">
                                                            ...
                                                            <input type="file" name="file" id="input-file-max-fs"
                                                                class="dropify"
                                                                data-default-file="<?php echo $row['admin_img']  ?>"
                                                                data-max-file-size="2M" />
                                                            <p class="mt-2"><i class="flaticon-cloud-upload mr-1"></i>
                                                                Upload
                                                                Picture</p>
                                                            <button class="btn btn-primary mb-2 mr-2" name="saveimg"><i
                                                                    class="fad fa-cloud-upload"></i> Upload
                                                                Image</button>
                                                        </div>
                                                    </div>
            ...
            if(($_FILES["file"]["type"]=="image/png")||($_FILES["file"]["type"]=="image/jpeg") ||($_FILES["file"]["type"]=="image/jpg") && in_array($file_extension,$valid_extensions))
             {
                ...
                $hostImg="assets/img/".$img_title;
                $query = "UPDATE admin SET      admin_img   = '$hostImg'
                                       WHERE 	admin_email =  '$email'
                                       AND      id          =   $ID";
                                            ...
                                            <div class="col-md-11 mx-auto">
                                                ...
                                                <div class="platform-div">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control mb-4" id="platform-title"
                                                            placeholder="Platforms Title" value="Web Design">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control mb-4"
                                                                    id="degree1" placeholder="Add your education here"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control mb-4"
                                                                            id="degree3"
                                                                            placeholder="Add your work here" value="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
