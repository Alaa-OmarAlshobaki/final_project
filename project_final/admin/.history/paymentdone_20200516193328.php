                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-right">
                                                                            <?php
                                                                            $queryCheck="SELECT * FROM cat_discount_pro WHERE id_pro=$pro";
                                                                            $resCheck=mysqli_query($conn,$queryCheck);
                                                                            $rowCheck=mysqli_fetch_assoc($resCheck);
                                                                            
                                                                            if(isset($rowCheck['id_des'])){
                                                                                echo $row2['list_price']-($row2['list_price']*$rowCheck['id_des']/100) ;
                                                                            }else{
                                                                                echo $row2['list_price'];
                                                                            }
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8 col-7">
                                                                    <p class=" discount-rate">Discount : <span
                                                                            class="discount-percentage"><?php if($row1['quantity']> 5){
                                                                                echo "50%";
                                                                                   }else {
                                                                                       echo "no discount";
                                                                                   }
