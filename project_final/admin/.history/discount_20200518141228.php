                                ...
                                <table id="range-search" class="display table table-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Discount Unit <i class="fal fa-percent text-danger"></i> </th>
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea class="form-control" placeholder="add description for discount if you want"
                                    id="desDisc" name="desDisc" id="exampleFormControlTextarea1" rows="3"></textarea>
                            </div>
                            <div class="form-group mb-4">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" placeholder="add discount value" name="desc_val" id="desc_val"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="form-group mb-4">
