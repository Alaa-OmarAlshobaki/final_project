...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <div class="header-container fixed-top">
        <header class="header navbar navbar-expand-sm expand-header">
            ...
            <a href="../index.php" class="d-flex justify-content-end h1 pl-5 ml-5 text-center "><i
                    class="fal fa-home-lg-alt"><br><span class="h4">HOME</span></i></a>
            <a href="../logout.php" class="d-flex justify-content-end h1 pl-5  text-center "><i
                    class="fal fa-sign-out-alt"><br><span class="h4">LOGOUT</span></i></a>
        </header>
    ...
    <div class="main-container container-fluid sidebar-closed sbar-open" id="container">

        <div class="overlay container-fluid"></div>
        <div class="cs-overlay container-fluid"></div>
        <div class="search-overlay container-fluid"></div>
