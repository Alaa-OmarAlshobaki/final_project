                                ...
                                <table id="multi-column-ordering" class="table table-hover" style="width:100%">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <i onclick="editModal(<?="'".base64_encode($rowRead['category_name'])."','".base64_encode($rowRead['category_dec'])."','".$rowRead['category_img']."','".$id_category."'";?>)"
                                                    class="fas fa-edit "></i>
                                            </td>
                                        </tr>
                                        <?php  } ?>
                                    ...
                                    <?php
                                     if($_SERVER["REQUEST_METHOD"] == "POST"){
                                        ...
                                        if(isset($_POST['modal']) AND $_POST['type']=='save'){
                                          ...
                                          echo "<div class='alert alert-danger' role='alert'>
                                          This is a$cat_id alert with <a href='#' class='alert-link'>an example link</a>. Give it a click if you like.
                                        </div>";
                                          echo $cat_id;
                                          die();
