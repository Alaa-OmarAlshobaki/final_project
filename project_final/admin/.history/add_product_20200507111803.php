...
<body class="alt-menu sidebar-noneoverflow" data-spy="scroll" data-target="#navSection" data-offset="100">
                            ...
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    <div id="circle-basic" class="">
                                        ...
                                        <section>
                                            <div>
                                                ...
                                                <form class="needs-validation" method="POST" action="">
                                                    <div class="form-row">
                                                        <input type="text" name="id_cat" id="idCat" value="">
                                        ...
                                        <h3>upload multiple image for book</h3>
                                        <section>
                                            <div>
    ...
    if (isset($_POST['btn_upload'])) {
       ...
       echo "fffffffffffffffffff$idProud";
       die();
    ...
    if (!file_exists("uploads/$name_category/$name_product/")) {
        ...
        for ($i = 0; $i < count($_FILES['file_img']['name']); $i++) {
            ...
            $filepath = "uploads/$name_category/$name_product/".$filename;

            move_uploaded_file($filetmp, $filepath);

            $sqlRead = "INSERT INTO gallery (pro_id, image) VALUES ('$idProud','$filepath')";
