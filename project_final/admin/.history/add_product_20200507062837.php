...
<body class="alt-menu sidebar-noneoverflow" data-spy="scroll" data-target="#navSection" data-offset="100">
                                            ...
                                            if(isset($_POST['submit'])){
                                                ...
                                                $sql = "INSERT INTO `product`(`prod_name`, `prod_desc`, `author_name`, `price_prod`, `product_qty`, `id_cat`) 
                                                      ...
                                                      if(mysqli_query($conn, $sql)){
                                                        ...
                                                        echo"<input type='hidden' id='lastInsert' value='{$row['id']}'>";
                                                      }
                                        ...
                                        <section>
                                            <div>
                                                <div class="custom-file-container" data-upload-id="mySecondImage">
                                                    <input type="text" name="" id="idpro" value="">
    ...
    <script type="text/javascript">
    $(document).ready(function() {
        $("#insertProd").onclick(function() {
            //get selected parent option 
            var pro_id = $("#lastInsert").val();
            //alert(admin_id);
            $.ajax({
                type: "GET",
                url: "ajax.php?pro_id=" + pro_id,
                success: function(data) {
                    $("#idpro").val(data);
                }
            });
