                                    ...
                                    <?php
                                     if($_SERVER["REQUEST_METHOD"] == "POST"){
                                       ...
                                       if(isset($_POST['modal']) AND $_POST['type']=='add'){
                                           ...
                                           $query="INSERT INTO category (cat_name,cat_img) Values ( '$cat_name','$hostImg' )";
                                           mysqli_query($conn,$query);
                                           direct('mange_category.php');
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea class="form-control" name="cat_desc" id="exampleFormControlTextarea1"
                                rows="6"></textarea>
                        </div>
