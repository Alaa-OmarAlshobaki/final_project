                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button type="button" class="btn btn-info btn-sm mr-2"> <i
                                                        onclick="editModal('<?php echo $rowRead['category_name']  ?>','<?php echo $rowRead['category_dec']  ?>','<?php echo $rowRead['category_img']  ?>','<?php echo $rowRead['id']  ?>')"
                                                        class=" fas fa-edit "></i>
                                                </button>
                                            </td>
                                        </tr>
