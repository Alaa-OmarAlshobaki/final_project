                                            ...
                                            <li class="nav-item">
                                                <div class="nav-link list-actions" id="invoice-00001"
                                                    ...
                                                    <div class="f-m-body">
                                                        ...
                                                        <div class="f-body">
                                                            <p class="invoice-number"><?php echo $row['id_order']  ?>
                                                            </p>
                                                 ...
                                                 if($_SERVER["REQUEST_METHOD"] == "POST"){
                                                    ...
                                                    ?>
                                                        ...
                                                        <p class="inv-street-addr">
                                                            <?php echo $row1['city_customer'] ?>,<?php echo $row1['street_customer'] ?>
                                                        </p>
                                                        <p class="inv-email-address"><?php $row['email_customer'] ?></p>
                                                    </div>
