                        ...
                        ?> <form action="" method="post">
                                                <li class="nav-item">
                                                    <div class="nav-link list-actions" id="invoice-00001"
                                                        data-invoice-id="<?php echo$row['id_order'] ?> <?php echo $row['full_name_customer'] ?>">
                                                        <div class="f-m-body list-actions  data-invoice-id="
                                            ...
                                            <div class="content-section  animated animatedFadeInUp fadeInUp">
                                                    ...
                                                    <div class="col-sm-6 col-12 align-self-center text-sm-right">
                                                        <div class="company-info">
                                                            <div class="avatar avatar-xl">
                                                                <img alt="avatar" src="../image/logo.png"
                                                                    class="rounded" />
                                                            </div>
                                                ...
                                                <div class="row inv--detail-section">
                                                    ...
                                                    <div
                                                        ...
                                                        <p class="inv-detail-title">From : Pustok.</p>
                                                    </div>
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-right">
                                                                            <?php echo $row2['quantity']  ?></td>
                                                                        <td class="text-right">
                                                                            <?php echo $row2['price_prod']  ?></td>
                                                        ...
                                                        <div class="inv--total-amounts text-sm-right">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-4 col-5">
                                                                    <p class="">
                                                                        <?php
                                                                     $querTotal="select total from order_table
                                                                                 where id_order=$idOrder";
                                                                                 $res=mysqli_query($conn,$querTotal);
                                                                                 $rowTotal=mysqli_fetch_assoc($res);
                                                                                 echo $rowTotal['total'];
