                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <i onclick="editModal(<?="'".base64_encode($rowRead['category_name'])."','".base64_encode($rowRead['category_dec'])."','".base64_encode($rowRead['category_img'])."','".base64_encode($id_category)."'";?>)"
                                                    class="fas fa-edit "></i>
                                            </td>
                                        </tr>
                                        <?php  } ?>
